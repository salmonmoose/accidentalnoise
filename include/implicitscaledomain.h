...
class CImplicitScaleDomain : public CImplicitModuleBase
{
    ...
    double getDoubleYScale();
    double getDoubleZScale();
    double getDoubleWScale();
    double getDoubleUScale();
    double getDoubleVScale();
    ...
    CImplicitModuleBase *getNoiseXScale();
    CImplicitModuleBase *getNoiseYScale();
    CImplicitModuleBase *getNoiseZScale();
    CImplicitModuleBase *getNoiseWScale();
    CImplicitModuleBase *getNoiseUScale();
    CImplicitModuleBase *getNoiseVScale();
